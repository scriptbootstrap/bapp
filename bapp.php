...
// query table bapp
$queryBapp = query("SELECT * FROM tb_bapp");
...
<head>
	...
	<title>Data Berita Acara Penyelesaian Pekerjaan - SiKuDa BaJa</title>
...
<body>
	<div class="wrapper">
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Data Berita Acara Penyelesaian Pekerjaan </h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Data Berita Acara Penyelesaian Pekerjaan
							</li>
						</ul>
					</div>
					<div class="row">
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<a href="add-bapp" class="btn bg-skb-3 text-white btn-round"><i class="fa fa-plus"></i> Buat BAPP</a>
										<h4 class="card-title ml-auto"><?php echo "{$resultBAPP["jmlhBAPP"]}"; ?> Data BAPP</h4>
									</div>
								</div>
								<div class="card-body">
															...
															<div class="form-button-action">
																<div class="dropdown show">
																	...
																	<div class="dropdown-menu dropdown-menu-opsi" aria-labelledby="dropdownMenuLink">
																		<a class="dropdown-item text-light bg-skb-3" href="edit-bapp?id_bapp=<?= $row["id"]; ?>"><i class="fa fa-edit"></i> Edit</a>
																		...
																		<form action="print-word" method="post">
																			...
																			<input type="text" hidden name="no_bahpp" value="<?= $row["no_bahpp"]; ?>">
																			<input type="text" hidden name="tgl_no_bahpp" value="<?= tgl_indo(substr($row["no_bahpp"], -4, 5) . "-" . substr($row["no_bahpp"], 0, 2) . "-" . substr($row["no_bahpp"], 3, 2)); ?>">
																		...
																		<a class="dropdown-item text-light bg-skb-6" href="#" data-toggle="modal" data-target="#delete-bapp<?= $row["id"]; ?>"><i class=" fa fa-trash"></i> Hapus</a>
		...
		<!-- Modal Delete bapp -->
		<?php foreach ($queryBapp as $row) : ?>
			<div class="modal fade" id="delete-bapp<?= $row["id"]; ?>" tabindex=" -1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLongTitle">Hapus BAPP?</h5>
						...
						<div class="modal-footer">
							...
							<a href="delete-bapp?id_del_bapp=<?= $row["id"]; ?>" type="button" class="btn bg-skb-1 text-white">Hapus</a>
						</div>
					</div>
				</div>
			</div>
